...
public abstract class LockFileReader {
	...
	public void read() throws IOException, SQLException {
		if (this.sourceFilePath == null || 
				Files.notExists(this.sourceFilePath) ||
				!Files.isRegularFile(this.sourceFilePath) ||
				!Files.isReadable(this.sourceFilePath))
			throw new IOException("Error, could not find source file" + (this.sourceFilePath == null ? "" : ": " + this.sourceFilePath.toAbsolutePath().toString()) + "!");
