...
public class ExampleReport implements PropertyChangeListener {
	...
	public static void main(String[] args) throws Exception {
		...
		adjustment.addPropertyChangeListener(new ExampleReport());
		...
		// adjustment.setAdjustmentResultWriter(new org.applied_geodesy.util.io.writer.MatlabResultWriter("adjustment_results"));
