...
public class RadiallySymmetricDistortionModel extends PolynomialDistortionModel {
	...
	public RadiallySymmetricDistortionModel(Camera camera, double r0) {
		super(camera, r0);
	}
	 ...
	 *       2          4          6                (2*i)           2           4           6                (2*i) 
	 * A1 * r  +  A2 * r  +  A3 * r  + ... +  Ai * r      - (A1 * r0  +  A2 * r0  +  A3 * r0  + ... +  Ai * r0);
	 * @param order
	 * @return coefficient
	 */
	@Override
	public PolynomialCoefficient<RadiallySymmetricDistortionModel> add(int order) {
		if (order <= 0)
		...
		PolynomialCoefficient<RadiallySymmetricDistortionModel> coefficient = new PolynomialCoefficient<RadiallySymmetricDistortionModel>(ParameterType.RADIAL_POLYNOMIAL_A, this, order);
